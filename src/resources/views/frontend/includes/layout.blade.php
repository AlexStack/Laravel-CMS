...
<html lang="{{config('laravel-cms.template_language')}}">
    <head>
        ...
        <link rel="stylesheet" href="/laravel-cms/{{config('laravel-cms.template_frontend_dir')}}/css/main.css">
    ...
    <body>
        ...
        <script src="/laravel-cms/{{config('laravel-cms.template_frontend_dir')}}/js/bottom.js"></script>
